...
abstract class SlackNotificationPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        // To use interface-implementation approach.
//        val slackExtension = project.extensions.create(
//            SlackNotificationExtension::class.java,
//            "slackNotification",
//            SlackNotificationExtensionImpl::class.java
//        ).apply {
//            enabled.convention(true)
//            defaultConfig.message.convention("")
//        } as SlackNotificationExtensionImpl

        // Two APIs that retrieves element by name.
//        slackExtension.channels.getByName("name") // Return the element directly
//        slackExtension.channels.named("name") // Return the Provider of this element
//        project.tasks.whenTaskAdded { println("tasks added ${this.name}") }
//        project.tasks.whenObjectAdded { println("object added ${this.name}") }
        // To test the live data set.
//        slackExtension.channels.whenObjectAdded {
//            println("slackExtension whenObjectAdded" + this.name)
//        }
//        val androidSet = slackExtension.channels
//            .matching { it.name.contains("android", false) }
//        println("androidSet: " + androidSet.size) // size = 0, you can consider why 0 not 2?
//        slackExtension.channels.add(object : SlackChannel{
//            override val token: Property<String>
//                get() = project.objects.property<String>().convention("token")
//            override val channelId: Property<String>
//                get() = project.objects.property<String>().convention("id")
//
//            override fun getName(): String {
//                return "androidDefault"
//            }
//        })
//        println("androidSet: " + androidSet.size) // size = 1, we did not retrieve it again, the result will be updated automatically.
