...
本书 Reviewer 包括多位一线大厂的 Android 基建专家，以及来自 Gradle / Android Studio / Kotlin 团队的工程师们和布道者。英文版还得到了来自 Gradle 官方 Newsletter 的[推荐](https://newsletter.gradle.org/2024/04)。
...
- Kotlin 刷题专栏，包括 100+ 高频题的 Kotlin 实现和最简答案（重在好记好复用，而不是最佳答案）。
...
- [本书各节参考资料](https://github.com/2BAB/Extending-Android-Builds-Playground/blob/main/reference_per_section.md)
...
本 FAQ 写于 2023 年，此时媒介发展的多元性已经超出我们的想象，就如同未来我们与 app 交互可能是 AI 对话框一样——我目前只能说这是一个混合模式。如果按照内容重点划分，70% 是电子书和其他专栏，15% 是新知预告，15% 是问答和会员播客。
